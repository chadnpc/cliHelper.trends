...
#!/usr/bin/env pwsh
# .SYNOPSIS
#   cliHelper.trends buildScript v0.1.0
# .DESCRIPTION
#   A custom build script for the module cliHelper.trends
# .LINK
#   https://github.com/79479952+chadnpc/cliHelper.trends/blob/main/build.ps1
# .EXAMPLE
#   ./build.ps1 -Task Test
